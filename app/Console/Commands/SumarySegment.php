                ...
                if (count($data) > 0) {
                    foreach ($data as $key => $value) {
                        ...
                        DB::insert("INSERT INTO summary_segments (
                            ...
                            $value->av_wing_right ? $value->av_wing_right:0,
                            $value->wing_right_under_standard ? $value->wing_right_under_standard:0,
                            $value->wing_right_standard ? $value->wing_right_standard:0,
                            $value->wing_right_upper_standard ? $value->wing_right_upper_standard:0,
                            0,
