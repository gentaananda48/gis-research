...
class Kernel extends ConsoleKernel
{
    ...
    public function update_kualitas_rencana_kerja(){
        ...
        if(count($list_rk)>0){
            ...
            $successMessage = "Rencana Kerja kualitas updated successfully for IDs: " . implode(", ", $successIds);
            $errorMessage = "Failed to update Rencana Kerja kualitas for IDs: " . implode(", ", $errorIds);
            ...
            return "Failed to update Rencana Kerja kualitas: " . $e->getMessage();
        }
    }
