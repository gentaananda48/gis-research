...
$("#grid-data").bootgrid({
    ...
    formatters: {
        commands: function(a, t) {
            var e = '<a href="'+ BASE_URL + '/admin/role/edit/' + t.id + '" class ="btn btn-xs btn-info">' + 'Edit' + ' <i class="fa fa-edit" aria-hidden="true"></i></a>'  +
            ' <a href="'+ BASE_URL + '/admin/role/permission/' + t.id + '" class ="btn btn-xs btn-primary">' + 'Permission' + ' <i class="fa fa-lock" aria-hidden="true"></i></a>';
