$("#grid-data").bootgrid({
    ...
    rowCount: [20],
    url: BASE_URL + "/master/bahan/get" + window.location.search,
    navigation: 2,
    formatters: {
        commands: function(a, t) {
            var e = '<a href="'+ BASE_URL + '/master/bahan/edit/' + t.id + '" class ="btn btn-xs btn-info">' + ' <i class="fa fa-edit" aria-hidden="true"></i></a>';
