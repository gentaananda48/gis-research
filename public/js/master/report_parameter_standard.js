$("#grid-data").bootgrid({
    ...
    formatters: {
        commands: function(a, t) {
        	var e = '';
            e += '<a href="/master/report_parameter_standard/edit/' + t.id + '" class ="btn btn-xs btn-info">' + ' <i class="fa fa-edit" aria-hidden="true"></i></a>';
            e += ' <a href="/master/report_parameter_standard/detail/' + t.id + '" class ="btn btn-xs btn-info">' + ' <i class="fa fa-list" aria-hidden="true"></i></a>';
