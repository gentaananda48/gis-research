$("#grid-data").bootgrid({
    ...
    formatters: {
        commands: function(a, t) {
            var e = '<a href="/master/unit/edit/' + t.id + '" class ="btn btn-xs btn-info">' + 'Edit' + ' <i class="fa fa-edit" aria-hidden="true"></i></a>';
    ...
    $(".btn-delete").on("click", function() {
        deleteData(BASE_URL + "/master/unit/delete/" + $(this).data("id"), this);
    });
});