...
@section('content')
    ...
    <a href="{{ url('/master/alasan_pending/create') }}" class="btn btn-success btn-xs">Add <i class="fa fa-plus" aria-hidden="true"></i></a>
...
@section("script")
{!! Html::script('/js/master/alasan_pending.js') !!}
@stop
