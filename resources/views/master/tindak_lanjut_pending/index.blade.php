...
@section('content')
    ...
    <a href="{{ url('/master/tindak_lanjut_pending/create') }}" class="btn btn-success btn-xs">Add <i class="fa fa-plus" aria-hidden="true"></i></a>
...
@section("script")
{!! Html::script('/js/master/tindak_lanjut_pending.js') !!}
@stop
