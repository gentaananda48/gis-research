...
@section('content')
    ...
    <a href="{{ url('/master/report_parameter_standard/create') }}" class="btn btn-success btn-xs">Add <i class="fa fa-plus" aria-hidden="true"></i></a>
...
@section("script")
{!! Html::script('/js/master/report_parameter_standard.js') !!}
@stop
