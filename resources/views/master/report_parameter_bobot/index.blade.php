...
@section('content')
    ...
    <a href="{{ url('/master/report_parameter_bobot/create') }}" class="btn btn-success btn-xs">Add <i class="fa fa-plus" aria-hidden="true"></i></a>
                ...
                <table id="grid-data" class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th data-column-id="grup_aktivitas_nama">Grup Aktivitas</th>
                            <th data-column-id="report_parameter_nama">Report Parameter</th>
...
@section("script")
{!! Html::script('/js/master/report_parameter_bobot.js') !!}
@stop
