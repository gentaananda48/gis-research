				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							{{ Form::text('map_topleft', $data->map_topleft, array('placeholder' => 'Map Top-left', 'class' => 'form-control', 'data-bv-message'=>'Required', 'required')) }}
						</div>
						<div class="form-group">
							<label for="map_bottomright">Map Bottom-Right</label>
							{{ Form::text('map_bottomright', $data->map_bottomright, array('placeholder' => 'Map Bottom-Right', 'class' => 'form-control', 'data-bv-message'=>'Required', 'required')) }}
						</div>
					</div>
