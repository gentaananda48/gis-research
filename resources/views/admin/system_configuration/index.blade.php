...
@section('content')
    ...
    <section class="content container-fluid">
        <a href="{{ url('/admin/system_configuration/create') }}" class="btn btn-success btn-xs">Add <i class="fa fa-plus" aria-hidden="true"></i></a>
...
@section("script")
{!! Html::script('/js/admin/system_configuration.js') !!}
@stop
